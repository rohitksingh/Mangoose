    ...
    protected void onCreate(Bundle savedInstanceSstate)
    {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(SeasonDetailActivity.this,EpisodeDetailActivity.class);
                i.putExtra("tv_id","1399");
                i.putExtra("season_num","1");
                i.putExtra("episode_num","1");
                startActivity(i);
            }
        });

        URLBuilder urlBuilder = new SeasonIdURLBuilder(tvShowId,season_num);
